...
|----------------------|---------------------|--------------|---------------------|------------|---------------------------------------------|
| [chat.yixiaai.com](https://chat.yixiaai.com)   | GPT-4, GPT-3.5，deepseek-r1，GPT-o3、Claude 3.7 Sonnet、Grok-3 | 有              | 无需注册，直接使用        | ⭐⭐⭐⭐⭐    | 运营时长两年，支持 GPT-4o，内置 MJ 绘图，适合开发者与普通用户 |
| [lanjing.ai](https://chat.lanjing.ai)         | GPT-4, GPT-o1, Claude, deepseek-r1,GPT-o3、Claude、Grok  | 有              | 无需注册，直接使用        | ⭐⭐⭐⭐⭐    | 支持GPT-o1模型，一比一还原官网，可以使用实时语音对话，视频对话         |
